...
public class PrimitivesExample {
    ...
    public static void main(String[] args) {
        ...
        long distanceMore = 3_000_000_000L;  //we have to put L to define the veriable
        long distanceShorter = 1_000_000_000;  //if it does not pass the limit than we don't have to give

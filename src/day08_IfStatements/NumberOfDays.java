...
public class NumberOfDays {
    ...
    public static void main(String[] args) {
        ...
        boolean has30Days = number == 4 || number ==6 || number == 9 || number ==11;  //for the months that has 30 days in a month

        boolean has31Days = !has28Days && !has30Days; //if the month does not have 28 days and does not 30 days
        ...
        if (has31Days) {   //if the month has 28 days

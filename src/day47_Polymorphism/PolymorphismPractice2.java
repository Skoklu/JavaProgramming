...
public class PolymorphismPractice2 {
    ...
    public static void main(String[] args) {
       ...
       // 2.2 store all the testers into the following List of testers:
        ...
        for (Employee employee : employees) {
            if (employee.getSalary()>testerWithMaxSalary.getSalary()){
                testerWithMaxSalary = (Tester) employee;
            }
        ...
        for (Employee employee : employees) {
            if (employee.getSalary()>developerWithMaxSalary.getSalary()){
                developerWithMaxSalary= (Developer) employee;
            }

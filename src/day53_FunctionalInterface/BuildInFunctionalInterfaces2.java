...
public class BuildInFunctionalInterfaces2 {
    ...
    public static void main(String[] args) {
      ...
      */
        ...
        //1. create a function that takes two Integer and returns the maximum number
        ...
        List<Integer> score = new ArrayList<>(Arrays.asList(90, 95, 98));

        Map<String,Integer> students = merge2.apply(names, score);

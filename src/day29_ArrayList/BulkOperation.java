...
public class BulkOperation {
    ...
    public static void main(String[] args) {
        ...
        namesList2.addAll(Arrays.asList(names));
        ...
        System.out.println(Arrays.toString(arr));  //this is normal array execution
        System.out.println("list2 = " + list2);  // this is collecting method execution

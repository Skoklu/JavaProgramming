...
public class ArraysUtility {
    ...
    //Prints each integer of the integer array in separate lines
    ...
    //Prints each double of the char array in separate lines
...
public static boolean contains(int[] array, int element){
    ...
    for (int each : array) {
        ...
        if (each == element){  //if any array's element is matching with the given element,--->
            // it means the given elements is contained in the array
           result= true; 
        }

...
public class NestedMap {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> map2 = new LinkedHashMap<>(); //names & salary
        ...
        Map<Map<Map<Integer, Integer>, Map<Integer, Integer>>,Map< Map<Integer, Integer>, Map<Integer, Integer>>> mapOfMapOfMap
                = new LinkedHashMap();
